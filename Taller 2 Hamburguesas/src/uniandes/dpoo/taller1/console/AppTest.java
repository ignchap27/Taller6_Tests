...
public class AppTest {
	@Test
	   public void testOrder1(Order order) {
	       ...
	       System.out.println("\nTest for adding products and getting price completed succesfully");
	    }
	 	public void testOrder2(Order order) {
	       assertEquals(57900, order.getprice());
	       System.out.println("\nTest for adding 3 products and getting price completed succesfully");
	    }
	 	public void testOrder3(Order order) {
		       assertEquals(17000, order.getprice());
		       System.out.println("\nTest for adding 3 products and adjusted product and getting price completed succesfully");
		    }
}
